...
def test_circle_select_tool(app_and_window, qtbot):
    """
    Tests that the circle select tool creates a selection correctly.
    """
    app, window, canvas = app_and_window

    # 1. Select the circle select tool
    app.set_tool("Select Circle")
